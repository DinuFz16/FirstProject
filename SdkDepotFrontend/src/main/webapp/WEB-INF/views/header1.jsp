...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card">
    ...
    <a href="ProductPage" class="w3-bar-item w3-button w3-padding-large w3-hide-small"><span class="glyphicon glyphicon-ok"></span> PRODUCT</a>
    <a href="#" class="w3-bar-item w3-button w3-padding-large w3-hide-small"><span class="glyphicon glyphicon-user"></span>   ${user.username}</a>
